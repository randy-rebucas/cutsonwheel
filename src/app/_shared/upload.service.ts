...
import { DocumentsData } from '../setup/documents/documents-data.model';
...
export class UploadService {
  private files: DocumentsData[] = [];
  private filesUpdated = new Subject<{ files: DocumentsData[], count: number }>();
  ...
  getFile(fileId: string) {
    ...
    return this.http.get<DocumentsData>(
      BACKEND_URL + '/' + fileId
      );
  }
